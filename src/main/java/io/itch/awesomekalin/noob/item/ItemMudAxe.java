...
public class ItemMudAxe extends ElementsTheGameofNoobs.ModElement {
	@GameRegistry.ObjectHolder("noob:mudaxe")
	public static final Item block = null;
	public ItemMudAxe(ElementsTheGameofNoobs instance) {
		super(instance, 9);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("noob:mudaxe", "inventory"));
	}
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("MUDAXE", 1, 10, 1f, -3.9f, 1), effective_items_set);
			this.attackDamage = -3.9f;
			this.attackSpeed = -3f;
		}
