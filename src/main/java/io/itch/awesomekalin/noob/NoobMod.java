 ...
 *
 *    Keep the ElementsNoobMod object in this class and all calls to this object
...
public class NoobMod {
	...
	@Mod.Instance(MODID)
	public static NoobMod instance;
	public ElementsNoobMod elements = new ElementsNoobMod();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsNoobMod.GuiHandler());
